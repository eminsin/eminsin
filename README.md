...
| Multiple Linear Regression<br>OLS Estimation<br>Hypothesis Testing: F-test<br>Model Selection:<br>- R-squared, Leave-one-out Cross Validation, AIC, BIC<br>Model Diagnosis:<br> - Linearity, Homoscedasticity, VIF<br>- Variable Selection:<br> &nbsp;&nbsp;- Influence Analysis (Outliers, Leverage, Cook's Distance)<br>- Heteroscedastic Errors:<br> &nbsp;&nbsp;- Breusch-Pagan Test<br> &nbsp;&nbsp;- Two-Stage Least Squares<br> &nbsp;&nbsp;- White-Estimators<br>Price Prediction | [![RegAnaCoursePoject](https://img.shields.io/badge/github-repo-blue?logo=github)](https://github.com/eminsin/Price_Prediction_with_Regression_Analysis)<br>![RegAnaCourseProject](https://img.shields.io/badge/Price%20Prediction%20with%20Regression%20Analysis-8A2BE2)<br>![book](https://img.shields.io/badge/Book:%20Regression%20Models,%20Methods%20and%20Applications-E22BBE) |        |
|     3|                |        |
|     3|                |        |
|     3|                |        |
|     3|                |        |
